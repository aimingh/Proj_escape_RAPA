...
int main()
{
    char *FloStr2 = "1.+RTCcontrol+system+(7.13-8.28) 1.+RTCcontrol+system+(7.13-8.28) 1.+RTCcontrol+system+(7.13-8.28) 1.+RTCcontrol+system+(7.13-8.28) 1.+RTCcon";
    char *FloStr1 = "RTC control/7.13-8.28*Big data analysis/8.31-9.4*Comprehensive flight/10.27-11.9*Custom drone production/11.10-12.3*Autonomous flight using AI/12.4-1.26*Final Project/1.11-1.27";
